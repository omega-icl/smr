...
SCALARS
  CHI2         chi-square 1DOF 0.68 (1-sigma)        / 1.0   /
...
FILE results /SMR_CARD_L2_INDEP_1SIG.out/;
results.AP = 1;
PUT results;
...
MODEL lkhcntr / obj_lse, nco_Tmin, nco_Tmax, nco_Topt, nco_Mopt, ctr_objerr /;
...
MODEL bnd_Tmin /obj_Tmin,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmax /obj_Tmax,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Topt /obj_Topt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Mopt /obj_Mopt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmin_p_Tmax /obj_Tmin_p_Tmax,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmin_m_Tmax /obj_Tmin_m_Tmax,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmin_p_Topt /obj_Tmin_p_Topt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmin_m_Topt /obj_Tmin_m_Topt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmin_p_Mopt /obj_Tmin_p_Mopt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmin_m_Mopt /obj_Tmin_m_Mopt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmax_p_Topt /obj_Tmax_p_Topt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmax_m_Topt /obj_Tmax_m_Topt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmax_p_Mopt /obj_Tmax_p_Mopt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Tmax_m_Mopt /obj_Tmax_m_Mopt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Topt_p_Mopt /obj_Topt_p_Mopt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
...
MODEL bnd_Topt_m_Mopt /obj_Topt_m_Mopt,nco_Tmin,nco_Tmax,nco_Topt,nco_Mopt,ctr_objerr/;
